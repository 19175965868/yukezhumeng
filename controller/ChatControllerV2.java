...
public class ChatControllerV2 {
    ...
    private final String BOT_ID = "7474535678467227684";  // 这里可以换成另一个 bot ID
    private final String API_KEY = "Bearer pat_1zjzz88B2dItkjIcrRdMMuviYyE1I8FoEyipLJgEUWw25CzUl2UaMHVAB10kr71O";  // 可以更换 API Key
